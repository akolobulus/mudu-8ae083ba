...
const Blog = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-12 sm:pt-20 pb-10 sm:pb-16 text-center max-w-3xl mx-auto px-4" data-aos="fade-up">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4 sm:mb-6">Our Blog</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {posts.map((post, i) => (
            <div key={i} className="group" data-aos="fade-up" data-aos-delay={i * 100}>
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-foreground mb-3 sm:mb-4 leading-snug">{post.title}</h3>
              <Button variant="outline" className="rounded-full px-6 w-full sm:w-auto">Read Full Article</Button>
            </div>
          ))}
        </div>
      </section>
