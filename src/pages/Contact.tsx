    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-6xl mx-auto px-4 pb-24">
        <div className="grid md:grid-cols-[1fr_1.5fr] gap-8">
          {/* Contact Info Card */}
          <div className="bg-foreground text-background rounded-2xl p-8 flex flex-col justify-between min-h-[500px]">
            <div>
              <p className="text-xs uppercase tracking-widest text-muted-foreground mb-2">Send Direct Email</p>
              <p className="text-lg font-medium mb-12">officialarikpa@gmail.com</p>
            </div>
            <div>
              <p className="text-xs uppercase tracking-widest text-muted-foreground mb-2">Call Us</p>
              <p className="text-lg font-medium mb-12">+234 07042001836</p>
            </div>
            <div>
