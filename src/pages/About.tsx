    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-serif text-foreground leading-tight mb-8 max-w-3xl">
            Simplifying Access To Transparent Market Intelligence
          </h1>
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl ml-auto mb-12 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <img
              src={aboutHero1}
              alt="Nigerian market trader speaking"
              className="w-full h-[400px] object-cover rounded-2xl"
            />
            <img
              src={aboutHero2}
              alt="Nigerian woman using phone for market prices"
              className="w-full h-[400px] object-cover rounded-2xl"
            />
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <img
            src={aboutProblem}
            alt="Person checking market prices on WhatsApp"
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <img
            src={aboutSolution}
            alt="Young Nigerian woman confident about market solutions"
            className="w-full h-[500px] object-cover rounded-2xl"
          />
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-serif text-foreground text-center mb-12">
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          <div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-serif text-foreground mb-10">
              Why Choose Mudu?
            </h2>
          ...
          <img
            src={aboutWhy}
            alt="Nigerian student working on market intelligence"
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-serif text-foreground text-center mb-16">
            ...
            {[
              ...
              <div key={i} className="mb-4">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-lg font-bold text-foreground font-sans">{item.title}</h3>
                </div>
