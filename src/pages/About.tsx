    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-12 md:py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6 md:mb-8 max-w-3xl" data-aos="fade-up">
            Simplifying Access To Transparent Market Intelligence
          </h1>
          <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-2xl md:ml-auto mb-8 md:mb-12 leading-relaxed" data-aos="fade-up" data-aos-delay="100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <img src={aboutHero1} alt="Nigerian market trader speaking" className="w-full h-[250px] sm:h-[350px] md:h-[400px] object-cover rounded-2xl" data-aos="fade-right" data-aos-delay="200" />
            <img src={aboutHero2} alt="Nigerian woman using phone for market prices" className="w-full h-[250px] sm:h-[350px] md:h-[400px] object-cover rounded-2xl" data-aos="fade-left" data-aos-delay="300" />
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-24 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <img src={aboutProblem} alt="Person checking market prices on WhatsApp" className="w-full h-[300px] sm:h-[400px] md:h-[500px] object-cover rounded-2xl" data-aos="fade-right" />
          <div data-aos="fade-up">
            <p className="text-primary font-semibold mb-3 md:mb-4 text-sm sm:text-base">The Problem</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 md:mb-6">The Problem We're Solving</h2>
      ...
      <section className="py-12 md:py-24 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div data-aos="fade-up" className="order-2 md:order-1">
            <p className="text-primary font-semibold mb-3 md:mb-4 text-sm sm:text-base">The Solution</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 md:mb-6">How We Solve These Problems</h2>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
          ...
          <img src={aboutSolution} alt="Young Nigerian woman confident about market solutions" className="w-full h-[300px] sm:h-[400px] md:h-[500px] object-cover rounded-2xl order-1 md:order-2" data-aos="fade-up" />
        </div>
      </section>
      ...
      <section className="py-12 md:py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground text-center mb-8 md:mb-12" data-aos="fade-up">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={i} className="bg-card border border-border rounded-2xl p-5 sm:p-8" data-aos="fade-up" data-aos-delay={i * 100}>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 sm:w-6 sm:h-6 text-primary mt-0.5 shrink-0" />
      ...
      <section className="py-12 md:py-24 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
          <div data-aos="fade-up">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6 md:mb-10">Why Choose Mudu?</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              {[
                ...
                <div key={i} className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 sm:w-6 sm:h-6 text-primary mt-0.5 shrink-0" />
                  <p className="text-foreground text-xs sm:text-sm leading-relaxed">{item}</p>
                </div>
              ))}
            </div>
          </div>
          <img src={aboutWhy} alt="Nigerian student working on market intelligence" className="w-full h-[300px] sm:h-[400px] md:h-[450px] object-cover rounded-2xl" data-aos="fade-up" />
        </div>
      </section>
      ...
      <section className="py-12 md:py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground text-center mb-10 md:mb-16" data-aos="fade-up">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-10">
            {[
              ...
              <div key={i} className="mb-2 md:mb-4" data-aos="fade-up" data-aos-delay={i * 80}>
